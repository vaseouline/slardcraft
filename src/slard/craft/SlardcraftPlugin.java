...
public class SlardcraftPlugin extends JavaPlugin {
    ...
    private void addRecipes() {
        ...
        Recipe bigIronBreakDownRecipe = BigOre.getBigOreBreakDownRecipe(new NamespacedKey(this, "big_iron"),
                Material.RAW_IRON);
        Recipe megaIronBreakDownRecipe = BigOre.getMegaOreBreakDownRecipe(new NamespacedKey(this, "mega_iron"),
                Material.RAW_IRON);
        Recipe bigGoldBreakDownRecipe = BigOre.getBigOreBreakDownRecipe(new NamespacedKey(this, "big_gold"),
                Material.RAW_GOLD);
        Recipe megaGoldBreakDownRecipe = BigOre.getMegaOreBreakDownRecipe(new NamespacedKey(this, "mega_gold"),
                Material.RAW_GOLD);
        Recipe bigDiamondBreakDownRecipe = BigOre.getBigOreBreakDownRecipe(new NamespacedKey(this, "big_diamond"),
                Material.DIAMOND);
        Recipe megaDiamondBreakDownRecipe = BigOre.getMegaOreBreakDownRecipe(new NamespacedKey(this, "mega_diamond"),
                Material.DIAMOND);
